...
public class ClassConstraints {
    ...
    public static final String MOCK_DOCUMENT = "12224579";
    ...
    public static final List<GetUserDto> GET_STUDENT_DTO_LIST = Arrays.asList(
            GET_STUDENT_DTO_1,
            GET_STUDENT_DTO_2
    );
    ...
    public static final ResponseEntity<ResponseDto> GET_STUDENTS_BY_CLASS_ID_RESPONSE = ResponseEntity.ok().body(
            new ResponseDto(STUDENTS_FOUND, true,GET_STUDENT_DTO_LIST)
    );
    ...
    public static final ResponseEntity<ResponseDto> INVALID_GET_STUDENTS_RESPONSE = ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
            new ResponseDto(INVALID_TEACHER_DOCUMENT, false, null)
    );

    public static final ResponseEntity<ResponseDto> INVALID_GET_CLASS_RESPONSE = ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
            new ResponseDto(INVALID_TEACHER_DOCUMENT, false, null)
    );

    public static final AddStudentToClassDto ADD_STUDENT_TO_CLASS_DTO = new AddStudentToClassDto(MOCK_DOCUMENT);

    public static final ResponseEntity<ResponseDto> ADD_STUDENT_TO_CLASS_RESPONSE = ResponseEntity.ok().body(
            new ResponseDto(USER_ADDED_TO_CLASS, true, STUDENT_ADDED_TO_CLASS)
    );
    public static final ResponseEntity<ResponseDto> INVALID_ADD_STUDENT_TO_CLASS_RESPONSE = ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
        new ResponseDto(INVALID_TEACHER_DOCUMENT, false, null)
    );
}
