...
public class ClassConstraints {
    ...
    public static final GetUserDto GET_STUDENT_DTO_1 = new GetUserDto("José Mozart", "jose.mozart789@al.unieduk.com.br", "1224875", "564", "https://gravatar.com/avatar/dd95411d45214301e2673e1c6a8f5d47?s=400&d=robohash&r=x", "112", "Ciência Da Computação");
    public static final GetUserDto GET_STUDENT_DTO_2 = new GetUserDto("Luis Henrique", "luis.henrique789@al.unieduk.com.br", "1224175", "1034", "https://gravatar.com/avatar/dd95411d45214301e2673e1c6a8f5d47?s=400&d=robohash&r=x", "322", "Ciência Da Computação");
    ...
    public static final ResponseEntity<ResponseDto> GET_STUDENTS_BY_SUBJECT_ID_RESPONSE = ResponseEntity.ok().body(new ResponseDto(STUDENTS_FOUND, true, GET_STUDENT_DTO_LIST));
